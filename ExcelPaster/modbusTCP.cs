...
namespace ModbusTCP
{
    ...
    public class Master
    {
        ...
        /// <summary>Socket data event. This event is called when the data changes</summary>
        public delegate void SocketData(byte[] data, bool IsRecieve);
        /// <summary>Socket data event. This event is called when the data changes</summary>
        public event SocketData OnSocketData;
        ...
        private void OnReceive(System.IAsyncResult result)
        {
            ...
            fullResp = new byte[9+data.Length];
            Array.Copy(tcpAsyClBuffer, 0, fullResp, 0, fullResp.Length);
            OnSocketData(fullResp,true);
